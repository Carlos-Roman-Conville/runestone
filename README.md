...
- Composer prompts for engine modules handed off from Claude Code: `files/prompts/` (Placement, Clearing, Scoring; STEP5_VIEW for the playable view once step 1 is done). One prompt per chat; Claude Code reviews the diff.
